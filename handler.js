...
const mongoString = 'mongodb://arteight:arteight@ds141657.mlab.com:41657/arteight'; // MongoDB Url
...
module.exports.user = (event, context, callback) => {
  const db = mongoose.connect(mongoString, { useMongoClient: true });
...
module.exports.createUser = (event, context, callback) => {
  ...
  db = mongoose.connect(mongoString, { useMongoClient: true });
